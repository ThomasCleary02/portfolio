  ...
  <footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600">
    <div className="container pt-9">
      <div className="mb-9 flex justify-center">
        ...
        {/* LinkedIn Logo */}
        <a className="mr-9 text-neutral-800 dark:text-neutral-200" href="https://www.linkedin.com/in/t-cleary/">
            <svg
        ...
        { /* Email Logo */ }
        <a className="mr-9 text-neutral-800 dark:text-neutral-200" href="mailto:thomcleary15@gmail.com">
            <svg 
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
        ...
        {/* Indeed Logo */}
        <a className="mr-9 text-neutral-800 dark:text-neutral-200" href="https://profile.indeed.com/p/thomasc-jjm1y5b">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
        ...
        {/* GitHub Logo */}
        <a className="text-neutral-800 dark:text-neutral-200" href="https://github.com/ThomasCleary02">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
