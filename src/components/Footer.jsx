...
import { effects } from './animationVariants.js'
    ...
    <div className="container pt-9">
      <div className="mb-9 flex justify-center">
        ...
        <motion.a 
          ...
          variants={effects}
          className="mr-9 text-neutral-800 hover:to-blue-500 dark:text-neutral-200 group" href="https://www.linkedin.com/in/t-cleary/">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 fill-current text-black group-hover:text-blue-500 transition-colors duration-300 ease-in-out"
                fill="currentColor"
                viewBox="0 0 24 24">
        ...
        <motion.a
          whileHover="iconHover"
          variants={effects}
          className="mr-9 text-neutral-800 dark:text-neutral-200 group" href="mailto:thomcleary15@gmail.com">
            <svg 
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 fill-current text-black group-hover:text-blue-500 transition-colors duration-300 ease-in-out"
                fill="currentColor"
        ...
        <motion.a 
          whileHover="iconHover"
          variants={effects}
          className="mr-9 text-neutral-800 dark:text-neutral-200 group" href="https://profile.indeed.com/p/thomasc-jjm1y5b">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 fill-current text-black group-hover:text-blue-500 transition-colors duration-300 ease-in-out"
                fill="currentColor"
        ...
        <motion.a 
          whileHover="iconHover"
          variants={effects}
          className="text-neutral-800 dark:text-neutral-200 group" href="https://github.com/ThomasCleary02">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4 fill-current text-black group-hover:text-blue-500 transition-colors duration-300 ease-in-out"
                fill="currentColor"
